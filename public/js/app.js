...
addEventListenerSafely("#header__search__btn", "click", () => {
    ...
    toggleClasses(headerSearchBox, "max-w-[36px]", "md:max-w-[320px]", "max-w-[320px]", "gap-2");
});
...
document.querySelectorAll(".profile__xizmat__text").forEach((item, index) => {
    const profileXizmatClose = document.querySelectorAll(".profile__xizmat__close")[index];
    item.addEventListener("click", () => {
...
addEventListenerSafely("#res__pas__btn", "click", (e) => {
    ...
    // problem__btn__1.forEach(function(item, index) {
    //     item.addEventListener("click", function() {
    //         const isActive = item.classList.contains("problem__btn__1__active");

    //         // Remove the class from all elements
    //         problem__btn__1.forEach(btn => btn.classList.remove("problem__btn__1__active"));
    //         // Ensure all problem_nav_1 elements are hidden
    //         problem_nav_2.forEach(nav => {
    ...
    //         if (!isActive) {
    //             item.classList.add("problem__btn__1__active");

    //             // Toggle the class on the corresponding problem_nav_1 element if it exists
    //             if (problem_nav_2[index]) {
    //                 problem_nav_2[index].classList.remove("hidden");
    //                 problem_nav_2[index].classList.add("flex");
    //             }
    //         }
    //     });
    // });
    ...
    // problem__btn__2.forEach(function(item, index) {
    //     item.addEventListener("click", function() {
    //         const isActive = item.classList.contains("problem__btn__2__active");

    //         // Remove the class from all elements
    //         problem__btn__2.forEach(btn => btn.classList.remove("problem__btn__2__active"));
    //         // Ensure all problem_nav_1 elements are hidden
    //         problem_nav_1.forEach(nav => {
    //             nav.classList.add("hidden");
    //             nav.classList.remove("flex");
    //         });
    ...
    //             // Toggle the class on the corresponding problem_nav_1 element if it exists
    //             if (problem_nav_1[index]) {
    //                 problem_nav_1[index].classList.remove("hidden");
    //                 problem_nav_1[index].classList.add("flex");
    //             }
    //         }
    //     });
    // });